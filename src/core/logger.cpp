...
static inline std::string_view level_to_color(roboctrl::log_level level){
    switch(level){
        case roboctrl::log_level::Debug:
            return _debug_color;
        case roboctrl::log_level::Info:
            return _info_color;
        case roboctrl::log_level::Warn:
            return _warn_color;
        case roboctrl::log_level::Error:
            return _error_color;
        default:
            std::unreachable();
    }
...
void roboctrl::logger::log_impl(log_level level, std::string_view role, std::string_view message) {
